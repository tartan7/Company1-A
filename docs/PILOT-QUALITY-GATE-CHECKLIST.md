# Pilot Quality-Gate Checklist (v1)

This checklist is the working copy version of the quality-gate template.
For reusable baseline structure, see `docs/PILOT-QUALITY-GATE-CHECKLIST-TEMPLATE.md`.
